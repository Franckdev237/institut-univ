...
export default function Navbar() {
  return (
    <div className="fixed top-0 w-full z-50 no-print font-sans">
      {/* 📢 1. BANDEAU BREAKING NEWS - Style Plus Pro */}
      <div className="bg-blue-900 text-white py-2 overflow-hidden flex items-center border-b border-white/10 shadow-sm">
        ...
        <div className="relative flex overflow-x-hidden font-bold text-[11px] uppercase tracking-wider">
          <div className="animate-marquee whitespace-nowrap py-1">
            ...
            <span className="mx-6 text-blue-400">•</span>
            <span className="mx-6">📅 Journée portes ouvertes à venir</span>
            <span className="mx-6 text-blue-400">•</span>
          </div>
        </div>
      </div>
      ...
      <nav className="bg-white/95 backdrop-blur-md shadow-lg border-b border-slate-100 p-3 flex justify-between items-center px-6 md:px-10">
        ...
        {/* MENU CENTRAL - Plus aéré et sans <br/> */}
        <div className="hidden lg:flex items-center gap-6 xl:gap-8 font-bold text-slate-700 text-[11px] uppercase tracking-widest">
           <a href="/" className="text-blue-600 relative after:content-[''] after:absolute after:w-full after:scale-x-100 after:h-0.5 after:bottom-[-4px] after:left-0 after:bg-blue-600 after:transition-transform">Accueil</a>
           ...
           <a href="/sante" className="hover:text-blue-700 transition-colors relative group">Santé</a>
           <a href="/polytechnique" className="hover:text-blue-700 transition-colors relative group">Ingénierie</a>
           <a href="/gestion" className="hover:text-blue-700 transition-colors relative group">Communication</a>
           <a href="/galerie" className="hover:text-blue-700 transition-colors relative group">Galerie</a>
           <a href="/contact" className="hover:text-blue-700 transition-colors relative group">Contact</a>
        </div>
